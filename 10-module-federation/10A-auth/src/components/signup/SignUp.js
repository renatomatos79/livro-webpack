        ...
        <div className="container mt-5 col-lg-6">
                ...
                <form>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="password" className="form-control" id="inputPassword" required={false}/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="inputConfirmPassword" className="form-label">Confirm Password</label>
                        <input type="password" className="form-control" id="inputConfirmPassword" required={false}/>
                    </div>
